...
- GIS = geografisch informatiesysteem = programma dat geografische data kan verwerken en tonen, bv. Q-GIS
...
percelen afbakenen en code geven met Q-GIS

### inventariseren

Twee methodes gebruikt :

- PQ : bepaalde stukjes van perceel inventariseren en gebruiken voor schatting van volledig perceel
- Streeplijst : alle plantensoorten

---

## verzamelde data per perceel
...
categorie op basis van beheertype en biodiversiteitswaarde

1. +++ = sleutelsoort, een soort die typisch is voor één of enkele habitattypes en esthetisch ook past bij dat beheertype;
2. ++  =  begeleidende/kenmerkende  soort,  een  soort  die  overeenstemt  met  het beheertype maar tot meerdere gelijkende habitattypes behoort, past esthetisch wel binnen het beheertype; 
3. \+ = algemene/indifferente soort, een soort die thuishoort in alle soorten grasland voorkomt en esthetisch past binnen het beheertype;
